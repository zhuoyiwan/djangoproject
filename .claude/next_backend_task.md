...
Start by reading `docs/architecture/backend-roadmap.md` and continue with the next unfinished backend milestone after the work represented by commit `0756e3d Update automation backend workflow.`.
