...
Start by reading `docs/architecture/backend-roadmap.md` and continue with the next unfinished backend milestone after the work represented by commit `6d9ea42 Update automation backend workflow.`.
